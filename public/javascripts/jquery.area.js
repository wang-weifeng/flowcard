...
var district = 	[
    /*浙江省*/
    [
        ["上城区", "下城区", "江干区", "拱墅区", "西湖区", "滨江区", "余杭区", "萧山区", "富阳区","下沙区", "建德市", "临安市", "桐庐县", "淳安县"],
...
function intProvince() {
	areaCont = "";
	console.log("省直辖县级行政单位",province.length)
...
/*关闭省市区选项*/
function clockArea() {
	// $('.page2').removeClass('oh-y')
	$("#areaMask").fadeOut();
	$("#areaLayer").animate({"bottom": "-100%","visibility": "hidden","opacity":0});
	intProvince();
}
...
$(function() {
	...
	$("#expressArea").on('click',function() {
		...
		setTimeout(function(){
			var vvv=0-$('.slide_box').position().top
			var height =$('.slide_box').height()
			var win_height=$(window).height()
			var value=height-win_height-vvv
			console.log(height)
			$("#areaMask").fadeIn();
			$("#areaLayer").animate({"bottom": value,"visibility": "visible","opacity":1});
			// console.log(0-$('.slide_box').position().top)
			// $('.page2').addClass('oh-y')
			// $('#areaMask').css('top',vvv)
		},400)
	})
	/*关闭省市区选项*/
	$("#areaMask, #closeArea").on('click',function() {
		clockArea();
	});
});