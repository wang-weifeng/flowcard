...
window.mobileUtil = (function(win, doc) {
    ...
    var designWidth = 640,
        factor = 1/6.4; // rem = idealLayoutWidth * device pix ratio * factor
    ...
    return {
        ...
        fixScreen: function() {
            ...
            function fillScale(scale) {
                return 'initial-scale=' + scale + ',maximum-scale=' + scale + ',minimum-scale=' + scale + ',user-scalable=0'+',width=device-width';
            }
        },
